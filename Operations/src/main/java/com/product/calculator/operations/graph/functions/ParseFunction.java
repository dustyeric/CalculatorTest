...
*****************/
     ...
     * @throws Exception Generic exception if the array index n<=0, or x is null.
     */
     ...
     * @return Array containing the solutions.
     * @throws Exception Generic exception if the array index n<=0, or x is null, or y is null.
     */
	 ...
	 ** Independent variables behave like constant nodes except
         ...
         */
            ...
            case Z:
                ...
                else if (token == Y) independent_y = true;
